...
// https://html.spec.whatwg.org/multipage/timers-and-user-prompts#timers
$({ global: true, bind: true, forced: MSIE }, {
  // `setTimeout` method
  // https://html.spec.whatwg.org/multipage/timers-and-user-prompts#dom-settimeout
  setTimeout: wrap(global.setTimeout),
  // `setInterval` method
  // https://html.spec.whatwg.org/multipage/timers-and-user-prompts#dom-setinterval
...
var SimpleLightbox = /*#__PURE__*/function () {
  ...
  _createClass(SimpleLightbox, [{
    ...
    value: function createDomNodes() {
      ...
      this.domNodes.navigation.innerHTML = "<button className=\"sl-prev\">".concat(this.options.navText[0], "</button><button className=\"sl-next\">").concat(this.options.navText[1], "</button>");
      this.domNodes.counter = document.createElement('div');
      this.domNodes.counter.classList.add('sl-counter');
      this.domNodes.counter.innerHTML = '<span className="sl-current"></span>/<span className="sl-total"></span>';
    ...
    value: function close() {
      ...
      this.fadeOut(document.querySelectorAll('.sl-image img,  .sl-close, .sl-navigation, .sl-image .sl-caption, .sl-counter'), this.options.fadeSpeed, function () {
        ...
        if (_this2.optionsClass && _this2.optionsClass !== '') {
          document.querySelector('html').classList.remove(_this2.optionsClass);
        }
    ...
    value: function openImage(element) {
      ...
      if (this.optionsClass && this.optionsClass !== '') {
        document.querySelector('html').classList.add(this.optionsClass);
      }
