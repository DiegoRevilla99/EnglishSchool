...
class SimpleLightbox {
    ...
    createDomNodes() {
        ...
        this.domNodes.navigation.innerHTML = `<button className="sl-prev">${this.options.navText[0]}</button><button className="sl-next">${this.options.navText[1]}</button>`;
    ...
    close() {
        ...
        this.fadeOut(document.querySelectorAll('.sl-image img,  .sl-close, .sl-navigation, .sl-image .sl-caption, .sl-counter'), this.options.fadeSpeed, () => {
            ...
            if (this.optionsClass && this.optionsClass !== '') {
                document.querySelector('html').classList.remove(this.optionsClass);
            }
